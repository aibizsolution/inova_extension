function createMeetingNotesGenerationDomain(deps) {
  ...
  function buildMeetingNotesSystemPrompt() {
    return [
      ...
      "단, 실제로 서로 다른 근거가 충분한 full 회의록이면 sourceTrace는 summary, 주요 discussionFlow, actionItems/openQuestions/risksOrDependencies 근거를 합쳐 4~6개까지 적극적으로 남기고, 네 개 이상 주요 항목이 있으면 4개에서 멈추지 말고 6개에 가깝게 작성한다.",
