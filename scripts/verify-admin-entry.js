...
function verifyAdminPageContract() {
  ...
  assert(
    pageSource.includes("listInovaAdminPanelNotices")
      ...
      && pageSource.includes("하루동안 안보기")
      && !pageSource.includes("오늘 안보기")
      ...
      && pageSource.includes('input.setAttribute("aria-invalid", "true")')
      && pageSource.includes('input.removeAttribute("aria-invalid")')
      && !pageSource.includes('input.toggleAttribute("aria-invalid"')
