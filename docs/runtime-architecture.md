...
5. extension은 `content/panel-v2-prompt-controller.js`를 통해 `activeTab`, review handoff signal, composer review float, prompt tool/query selection만 유지한다.
