...
5. extension은 `content/panel-v2-prompt-controller.js`를 통해 review handoff signal, activeTool/prompt-tab persistence, composer review float만 유지한다.
