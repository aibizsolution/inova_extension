...
| 먼저 볼 파일 | `content/dom.js`, `content/bookmark-view.js`, `content/route-state-controller.js`, `content/panel-bookmark-controller.js`, `content/panel-shell-controller.js`, `content/route-sync.js` |
