...
- prompt 계열의 공용 탭 셸인 `content/prompt-hub-view.js`는 단일 feature 소유가 아니라 prompt tool shell로 취급한다.
...
| 관련 프론트 경로 | `content/main.js`, `content/prompt-hub-view.js` (prompt tool shell) |
...
| 관련 프론트 경로 | `content/prompt-hub-view.js` (prompt tool shell), `content/main.js` |
...
| 관련 프론트 경로 | `content/main.js`, `content/composer.js`, `content/prompt-hub-view.js` (prompt tool shell) |
