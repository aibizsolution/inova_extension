...
- `content/main.js`는 panel shell의 composition root로만 두고, 북마크 흐름/공용 shell/route 상태/route watcher/회의 액션/디버그/prompt shell/surface/activity/lifecycle/render/bootstrap 책임은 전용 controller에 누적한다.
