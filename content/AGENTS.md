...
- panel shell 변경은 먼저 `content/main.js`, `content/route-state-controller.js`, `content/route-sync.js`, `content/panel-bookmark-controller.js`, `content/panel-shell-controller.js`, `content/panel-meeting-controller.js`, `content/panel-debug-controller.js`, `content/panel-prompt-controller.js`, `content/panel-lifecycle-controller.js`의 책임 경계를 확인하고 시작한다.
- `content/main.js`는 panel shell의 composition root로만 두고, 북마크 흐름/공용 shell/회의 액션/디버그/prompt shell/lifecycle 책임은 전용 controller에 누적한다.
