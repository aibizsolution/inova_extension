...
- `content/features/prompt-store/store-manager.js` - inactive legacy reference
- `content/features/prompt-store/prompt-realtime-manager.js` - inactive legacy reference
