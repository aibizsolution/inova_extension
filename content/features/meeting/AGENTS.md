...
- `1.0.0+` v2 lane에서는 `hosting/extension-v2/panel/meeting-hub-controller.js`가 회의 허브 목록/피드백/pending/share 상태와 작업실 열기 액션을 소유하고, extension은 runtime broker와 브라우저 탭 열기만 맡는다.
